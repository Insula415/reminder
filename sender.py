...
class Emailsender:
    def __init__(self):
        ...
        # Get user input
        text = input('What do you want to remind yourself? ')
        print("When do you want to recieve this reminder?")
        ...
        try:
            ...
            print(Fore.GREEN + "Email has been sent to",sender)
            ...
            print(Fore.RED + "Error sending email to",sender)
            print(Style.RESET_ALL)
